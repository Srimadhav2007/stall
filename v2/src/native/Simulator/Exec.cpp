...
vector<int> Core::execute(string& program){
    ...
    hardware["mmu"]["tlbHits"] = mmu.tlbHits;
    hardware["mmu"]["tlbMisses"] = mmu.tlbMisses;
    hardware["mmu"]["pageFaults"] = mmu.pageFaults;
    hardware["mmu"]["evictions"] = mmu.evictions;
    hardware["mmu"]["dirtyWritebacks"] = mmu.dirtyWritebacks;
    hardware["mmu"]["swapOuts"] = mmu.swapOuts;
    hardware["mmu"]["swapIns"] = mmu.swapIns;
    hardware["mmu"]["totalTranslationPenalty"] = mmu.totalTranslationPenalty;
